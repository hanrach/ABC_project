...
df_post = DataFrame(CSV.File("../data/covid19_bc_post_vaccine.csv"))
 ...
 save("../results/abc_solution_500_post.jld","abc_solutions",abc_solutions)
 save("../results/abc_mcmc_solution_500_post.jld","abc_mcmc_solutions",abc_mcmc_solutions)
 save("../results/abc_smc_solution_500_post.jld","abc_smc_solutions",abc_smc_solutions)
 ...
 savefig(beta_plot,"../figs/beta_plot_post.png")
 ...
 savefig(gamma_plot,"../figs/gamma_plot_post.png")
